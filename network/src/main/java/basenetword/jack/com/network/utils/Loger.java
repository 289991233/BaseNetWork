...
public class Loger {
    ...
    /**
     * Print log for define method. When information is too long, the Loger can also complete printing. The equivalent of "{@code android.util.Loger.i("Tag", "Message")}" "{@code com.yolanda.nohttp.Loger.print("i", "Tag", "Message")}".
     *
