...
package basenetword.jack.com.network.utils.baserecycleviewadapter;
...
public abstract class BaseQuickAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public int getItemViewType(int position) {
        ...
        if (mData.size() == 0 && mEmptyEnable && mEmptyView != null && position <= 2) {
            ...
            } else if (position == 2 && (mFootAndEmptyEnable || mHeadAndEmptyEnable) &&
                    mHeaderView != null && mEmptyView != null) {
                return FOOTER_VIEW;

            } /**
             * user forget to set {@link #setEmptyView(boolean, boolean, View)}  but add footview
             * and headview and emptyview
             */
            else if ((!mFootAndEmptyEnable || !mHeadAndEmptyEnable) && position == 1 &&
                    mFooterView != null) {
                return FOOTER_VIEW;
            }
        } else if (mEmptyView != null && getItemCount() == (mHeadAndEmptyEnable ? 2 : 1) &&
                mEmptyEnable) {
            return EMPTY_VIEW;
    ...
    private BaseViewHolder getLoadingView(ViewGroup parent) {
        if (mLoadingView == null) {
            return createBaseViewHolder(parent, R.layout.layout_footer_loading);
        }
    ...
    private boolean isLoadMore() {
        return mNextLoadEnable && pageSize != -1 && mRequestLoadMoreListener != null && mData
                .size() >= pageSize;
    }
    ...
    /**
     * @see #//convert(HomeBaseViewHolder, Object, Integer) ()
     * @deprecated This method is deprecated
     * {@link #//convert(HomeBaseViewHolder, Object, Integer)} depending on your use case.
     */
    @Deprecated
